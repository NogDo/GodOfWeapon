Shader "Shader Graphs/Indicator_StraightLine_Projectile" {
	Properties {
		...
		[HDR] _ReplaceColor ("ReplaceColor", Vector) = (1,1,1,0)
		_Opacity ("Opacity", Range(0, 1)) = 1
		_Scale ("Scale", Range(0, 1)) = 1
		_innerGlow ("innerGlow", Range(0, 1)) = 1
		_HybridScaleVector ("_HybridScaleVector", Vector) = (1,0,1,1)
